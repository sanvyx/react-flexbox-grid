...
storiesOf("Grid", module).add("Alignment self bottom", () => (
  <Layout title="Alignment self bottom" code={code}>
    <Grid gaps="1em" alignItems="flex-start">
      <Col xs={4}>
        <Content>
